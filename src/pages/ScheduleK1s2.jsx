...
class scheduleK1s2 extends Component {
  handleSubmit = (e) => {
    e.preventDefault()
  ...
  render() {
    ...
    return (
      <div className='create-scheduleK1-S2-form'>
            ...
            <Paper zDepth={2}>
              <Row>
                <Col xsOffset={1} xs={12} md={5}>
                  <h2>Schedule K1</h2>
                  <h3>(Form 1065)</h3>
                  {inputFields.filter(inputField => inputField.part === '1').map(inputField => (<RenderField key={inputField.name} inputField={inputField}/>))}
